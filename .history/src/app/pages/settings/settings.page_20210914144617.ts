...
export class SettingsPage implements OnInit {
  ...
  private async getDevice(): Promise<void> {
    const data: ReportsDevicesPayload = { active: ACTIVE, status_id: DEFAULT, deviceType: DEVICE_TYPE, deviceSerialNum: this.settingsService.uuid };
  ...
  private async addDevice(): Promise<void> {
    const data: DevicesPayload = {
      deviceSerialNumber: this.settingsService.uuid , vehicleNumber: DEFAULT, samNumber: DEFAULT, status_id: DEFAULT, appName: name,

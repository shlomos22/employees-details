...
export class LoginPage implements OnInit, AfterViewInit {
  ...
  private async initializeServer(): Promise<void> {
    const onInstallFiles = this.myElectronService.installFiles()
  ...
  private async onSuccessfulSignIn(res: GlobalDataResponse) {
    ...
    this.authService.typeRoleId = await this.storeService.get('typeRoleId')
    this.authService.loginStatus = 'CONNECTED'

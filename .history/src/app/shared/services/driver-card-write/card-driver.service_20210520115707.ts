...
export interface DriverCardWrite {
  command: string
...
export class DriverCardWriteService {

  public driverCardWrite: DriverCardWrite

  constructor() {
    this.driverCardWrite = {
      command: 'writeIsrDriverCard',
      driverEnviroment: {
        envCountryID: parseInt('886', 10),
      ...
      driverHeader: {
        ...
        lastUnloadingDate: '1997-01-01T00:00:00',
  ...
  public getDriverCardWriteObject(): DriverCardWrite {
    return this.driverCardWrite
  }

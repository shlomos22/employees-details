...
export class MyElectronService {
  ...
  public async installFiles() {
    ...
    .then(async () => await this.createPrinterFolder())
    .then(async () => await this.installReaderFile())
    .then(async () => await this.installReaderSettingsFile())
    .then(async () => await this.installPrinterFile())
    .then(async () => await this.installPrinterSettingsFile())
  }

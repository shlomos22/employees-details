...
import { OtherDevice, SettingsService } from '../../services/settings/settings.service';
...
export class CameraComponent implements OnInit {
  ...
  public async showNextWebcam(): Promise<void> {
    this.cameraId = (await this.storeService.get('cameraSettings') as OtherDevice).deviceSerNum
  }
